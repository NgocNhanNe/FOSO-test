...
export const NavigationBar = () => {
  return (
    <div className='w-full flex items-center justify-center fixed top-6 text-[#25272A]'>
      <div className='text-sm flex items-center justify-center w-[1280px] h-auto rounded-[40px] p-[12px_36px] gap-[64px] backdrop-blur-[25px] shadow-[inset_0px_2px_83.99px_rgba(0,0,0,0.02),-9px_20px_59.99px_-24px_rgba(0,0,0,0.05),1px_-1px_0px_0px_#FFFFFF,-1px_1px_0px_0px_#F0F0F0]'>
        <Image
          src={logo}
          alt='Company Logo'
          width={134}
        ...
        <div className='flex items-center justify-center gap-2'>
          ...
          <div className='flex items-center gap-3 py-2 px-3 w-fit bg-[#1AD598] rounded-[40px]'>
            <Link
              href={''}
